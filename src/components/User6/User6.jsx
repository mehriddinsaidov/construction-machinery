...
import user1Img1 from '../img/user6-img1.jpg'
import img2 from '../img/user6/img1.jpg'
import img3 from '../img/user6/img2.jpg'
import img4 from '../img/user6/img3.jpg'
import img5 from '../img/user6/img4.jpg'
import img6 from '../img/user6/img5.jpg'
import img7 from '../img/user6/img6.jpg'
        ...
        <div className='bg-[#f4f4f4]'>
            <Container>
                <div className='py-[40px] w-[100%] flex justify-between items-center'>
                    <div className='w-[32%] flex items-center justify-between tablet1:w-[50%]'>
                        <h1 className='text-[40px] font-[600] text-start w-[94%] tablet1:text-[20px]'>Дорожные катки </h1>
                        <p className='w-[5%] opacity-[0.6] text-[22px] pt-[7px] font-[600] tablet1:text-[16px]'>45</p>
                    </div>
