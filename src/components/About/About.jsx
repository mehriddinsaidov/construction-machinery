...
function About() {
    ...
    return (
        <div className='bg-[#f4f4f4]'>
            ...
            <div style={{backgroundImage: `url(${bg1})`}} className='tablet1:bg-center bg-[#f4f4f4] bg-cover text-start text-[#FFF] w-[100%] h-[60vh] flex flex-col justify-center'>
                <Container>
            ...
            <Container>
                ...
                <div className='tablet1:w-[100%] text-start w-[55%] py-[70px] text-[16px]'>
                    <p className='tablet1:text-[15px]'>В основе деятельности компании SHANTUI лежит ориентация на инновации и
                    ...
                    <p className='tablet1:text-[15px] py-[15px]'>История компании Shantui Construction Machinery началась в Китае в 1952-м
                    ...
                    <p className='tablet1:text-[15px]'>На сегодняшний день данная компания, принадлежащая государству, ее ценные
                ...
                <div className='text-start w-[55%] py-[70px] text-[15px] tablet1:w-[100%]'>
                    <p className='tablet1:text-[15px]'>Достаточно сказать, что SHANTUI стабильно входит в ТОП-50 мировых производителей специализированной строительной техники, а в сегменте бульдозеров начиная с 2005-го года, неизменно оказывается мировым лидером по объему произведенной продукции. Авторитет бренда в своем сегменте делает его технику востребованной не только на внутреннем рынке или в странах с развивающейся экономикой, но и в ведущих государствах мира.</p>
                    <p className='tablet1:text-[15px] py-[15px]'>С учетом огромных масштабов производства, компанией выстроены отлаженные цепочки сбыта готовой продукции. На сегодня приобрести спецтехнику SHANTUI можно в 160 странах мира, причем в каждой из них китайский производитель имеет не только официальные точки продаж, но и центры проведения сервисного послепродажного и гарантийного обслуживания. Только на внутреннем китайском рынке имеется 27 монобрендовых магазинов компании SHANTIU, более полусотни агентств и свыше 320 точек продаж.</p>
                    <p className='tablet1:text-[15px]'>В каждом случае компания готова предложить своим клиентам не только возможность приобретения всего спектра существующей техники SHANTUI, но и полноценное сервисное обслуживание, без которого эксплуатация сложной техники оказывается невозможна. Работа таких центров строится на основе строгих корпоративных стандартов вне зависимости от фактической страны присутствия.</p>
                </div>

                <div className='flex w-[100%] justify-between tablet1:flex-wrap'>
                    <div className='w-[43%] text-center tablet1:w-[100%]'>
                        <h1 className='text-start text-[36px] font-[700] tablet1:text-[25px]'>Сервисные центры по всему миру</h1>
                        <p className='text-start text-[17px] tablet1:text-[15px]'>Для работы на зарубежных рынках компания построила крупную сеть
                    ...
                    <div className='w-[50%] tablet1:w-[100%] tablet1:mt-[30px]'>
                        <img className='w-[100%]' src={about2} alt="" />
                    </div>
                </div>

                <div className='text-start w-[55%] py-[70px] text-[16px] tablet1:w-[100%]'>
                    <p className='tablet1:text-[15px]'>В контексте обслуживания техники компания SHANTUI строит собственный
                    ...
                    <p className='py-[15px] tablet1:text-[15px]'>Такой подход обеспечивает компании высокий
                    ...
                    <p className='tablet1:text-[15px]'>Обновление корпоративной стратегии развития компании привело к ее
                ...
                <div className='flex justify-between tablet1:flex-wrap'>
                    <div className='w-[43%] text-start tablet1:w-[100%]'>
                        <h1 className='text-start text-[36px] font-[700] tablet1:text-[25px]'>В ногу со временем</h1>
                        <p className='text-[17px] py-[20px] tablet1:text-[15px]'>Результаты такого подхода дают о себе знать. Например, еще в 2019-м
                        ...
                        <p className='text-[17px] tablet1:text-[15px]'>Одновременно компания ведет работу по внедрению
                ...
                <div className='text-start w-[55%] py-[70px] text-[16px] tablet1:w-[100%]'>
                    <p className='tablet1:text-[15px]'>Использование технологий 5G-связи характерно и для производственной
                    ...
                    <p className='py-[15px] tablet1:text-[15px]'>Руководство компании SHANTUI в настоящий момент работает над реализацией
