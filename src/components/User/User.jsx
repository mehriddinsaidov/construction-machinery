                ...
                <div className='bg-[#f4f4f4]'>
                    ...
                    <Container>
                        <div className='py-[40px] w-[100%] flex justify-between items-center'>
                            <div className='w-[27%] flex items-center justify-between tablet1:w-[45%]'>
                                <h1 className='text-[40px] font-[600] text-start w-[94%] tablet1:text-[21px]'>Автогрейдеры </h1>
                                <p className='w-[5%] opacity-[0.6] text-[22px] pt-[7px] font-[600] tablet1:text-[15px]'>6</p>
                            </div>
