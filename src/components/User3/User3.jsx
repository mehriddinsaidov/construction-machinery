...
import user1Img1 from '../img/user3-img1.jpg'
import img2 from '../img/user3/img1.jpg'
import img3 from '../img/user3/img2.png'
import img4 from '../img/user3/img3.png'
import img5 from '../img/user3/img4.png'
import img6 from '../img/user3/img5.jpg'
import img7 from '../img/user3/img6.png'
        ...
        <div className='bg-[#f4f4f4]'>
            <Container>
                <div className='py-[40px] w-[100%] flex justify-between items-center'>
                    <div className='w-[24%] flex items-center justify-between tablet1:w-[50%]'>
                        <h1 className='text-[40px] font-[600] text-start w-[94%] tablet1:text-[25px]'>Экскаваторы </h1>
                        <p className='w-[5%] opacity-[0.6] text-[22px] pt-[7px] font-[600] tablet1:text-[18px]'>13</p>
                    </div>
                    <div id='search' className='bg-[#FFF] w-[25%] h-[7vh] tablet1:h-[5.6vh] tablet1:w-[40%]'>
                ...
                <div className='flex justify-between pb-[50px]'>
                    ...
                    <div className='w-[73%] tablet1:w-[100%]'>
                        <div className='flex bg-[#FFF] p-[25px] justify-between tablet1:flex-wrap'>
                            ...
                            <div className='w-[40%] min-h-[90%] tablet1:w-[100%] tablet1:mt-[20px]'>
