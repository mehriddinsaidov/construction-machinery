...
import user1Img1 from '../img/user5-img1.jpg'
import img2 from '../img/user5/img1.jpg'
import img3 from '../img/user5/img2.jpg'
import img4 from '../img/user5/img3.jpg'
import img5 from '../img/user5/img4.jpg'
        ...
        <div className='bg-[#f4f4f4]'>
            <Container>
                <div className='py-[40px] w-[100%] flex justify-between items-center'>
                    <div className='w-[30%] flex items-center justify-between tablet1:w-[50%]'>
                        <h1 className='text-[40px] font-[600] text-start w-[94%] tablet1:text-[21px]'>Трубоукладчики </h1>
                        <p className='w-[5%] opacity-[0.6] text-[22px] pt-[7px] font-[600] tablet1:text-[17px]'>4</p>
                    </div>
                            ...
                            {arr.map((elem) => {
                                return (
                                    <div className='w-[32%] bg-[#FFF] mt-[20px] tablet1:w-[100%]'>
                                        <img className='p-[10px] w-[100%] h-[45vh]' src={elem.img} alt="" />
                                        <div className='p-[15px]'>
